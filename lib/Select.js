...
var Select = React.createClass({
   ...
   */
		...
		var ops = Object.keys(this.state.filteredOptions).map(function (key) {
			...
			if (op.disabled) {
				return React.createElement(
					'div',
					{ ref: ref, key: key, className: optionClass },
					renderedLabel
				);
			} else {
				return React.createElement(
					'div',
					{ ref: ref, key: key, className: optionClass, onMouseEnter: mouseEnter, onMouseLeave: mouseLeave, onMouseDown: mouseDown, onClick: mouseDown },
	...
	doesFilteredOptionExist: function doesFilteredOptionExist(option) {
		var match = false;
	...
	doesSelectedValueExist: function doesSelectedValueExist(value) {
		var match = false;
